...
def main_grouped(full_path, LAG):
    ...
    for index, row in df.iterrows():
        ...
        for drift_type in drift_types:
            ...
            if drift_type == "gradual":
                ...
                if all(not lst for lst in [actual_gradual_start, actual_gradual_end, detected_gradual_start, detected_gradual_end]):
                 continue 
                ...
                actual_drifts = list(zip(actual_gradual_start,actual_gradual_end))
                detected_drifts = list(zip(detected_gradual_start, detected_gradual_end))

                print(f"actual drifts: {actual_drifts}")
                print(f"detected drifts: {detected_drifts}")

                accuracy = []
                for (start, end) in detected_drifts:
                    start_detected = "no"
                    end_detected = "no"
...
#    evaluation_report.to_csv(os.path.join(os.path.dirname(full_path), f'{os.path.basename(full_path)[:-4]}_evaluated_grouped.csv'), index=True)
...
#    report = main(full_path, LAG)
    report = main_grouped(full_path, LAG)
...
if __name__ == "__main__":
    ...
    base_path_main = "/work/alexkrau/projects/scdd/data/output/20240226-161106_winsim_sgd_model_1/evaluation/general/" #m1
#    base_path_main = "/work/alexkrau/projects/scdd/data/output/20240228-174145_winsim_sgd_model_2/evaluation/general/" #m2
#    base_path_main = "/work/alexkrau/projects/scdd/data/output/20240228-231113_winsim_sgd_model_3/evaluation/general/" #m3
#    base_path_main = "/work/alexkrau/projects/scdd/data/output/20240301-235147_winsim_sgd_model_4/evaluation/general/" #m4
#    base_path_main = "/work/alexkrau/projects/scdd/data/output/20240302-004101_winsim_sgd_model_5/evaluation/general/" #m5
...
#    process_lag(all_args[0])
    ...
    report_all.to_csv(os.path.join(base_path_main, 'evaluation_results_grouped.csv'), index=True)
