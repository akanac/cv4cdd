...
if __name__ == "__main__":
    base_path_main = "/work/alexkrau/projects/scdd/data/output/input_cdrift"
    prodrift_options = ["winsim_200"] #["winsim_200"]
...
#    num_cores = cpu_count()-5
    ...
    report_all.to_csv(os.path.join(base_path_main, f'evaluation_results_scdd_external_{prodrift_options[0]}.csv'), index=True)
