...
if __name__ == "__main__":
    ...
    for prodrift_option in prodrift_options:
        ...
        window_size = prodrift_option.split("_")[1]
        report_all.to_csv(os.path.join(base_path_main, prodrift_option, f'evaluation_results_prodrift_{window_size}.csv'), index=True)
