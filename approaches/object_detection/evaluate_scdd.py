...
#    base_path_main = "C:\\Users\\alkraus\\ResearchGit\\scdd\\data\\output\\ProDrift"
    base_path_main = "/work/alexkrau/projects/scdd/data/output/ProDrift/"
    prodrift_options = ['window_150']

#    base_path_main = "/work/alexkrau/projects/scdd/data/models_trained/ak/20240211-172349_winsim_sgd/evaluation/general/"
#    base_path_main = "/work/alexkrau/projects/scdd/data/models_trained/ak/20240221-102516_winsim_sgd/evaluation/general/"
#    base_path_main = "/work/alexkrau/projects/scdd/data/output/20240226-161106_winsim_sgd/evaluation/general/"
#    prodrift_options = ["threshold_0.5"]

#    base_path_main = "/work/alexkrau/projects/scdd/data/output/external/"
#    prodrift_options = ["ostovar"]

    all_args = [(prodrift_option, LAG) for prodrift_option in prodrift_options for LAG in cfg.RELATIVE_LAG]

#    report = process_lag(all_args[2])
...
#    report_all.to_csv(os.path.join(base_path_main, 'evaluation_results_all_cp_only_external.csv'), index=True)
#    report_all.to_csv(os.path.join(base_path_main, 'evaluation_results_all_cp_only.csv'), index=True)
    report_all.to_csv(os.path.join(base_path_main, 'evaluation_results_prodrift_150.csv'), index=True)


#
# if __name__ == "__main__":
#     # training 1
#     #base_path = os.path.join("C:/Users/alkraus/ResearchGit/scdd/data/output/20240202-174505_winsim_sgd/evaluation/general/threshold_0.5/")
#     #base_path = os.path.join("/work/alexkrau/projects/scdd/data/output/20240202-174505_winsim_sgd/evaluation/general/threshold_0.5/")
#     # training 2
#     #base_path = os.path.join("C:/Users/alkraus/ResearchGit/scdd/data/output/20240205-125012_winsim_sgd/evaluation/general/threshold_0.5/")
#     # Training 3
#     #base_path = os.path.join("/work/alexkrau/projects/scdd/data/output/20240211-172349_winsim_sgd/evaluation/general/threshold_0.5/")
#     #base_path = os.path.join("C:\\Users\\alkraus\\ResearchGit\\scdd\\data\\output\\20240211-172349_winsim_sgd\\evaluation\\general\\threshold_0.5")
#     #base_path = os.path.join("/work/alexkrau/projects/scdd/data/output/ProDrift/")
#     base_path_main = os.path.join("C:\\Users\\alkraus\\ResearchGit\\scdd\\data\\output\\ProDrift")
#     #base_path_main = os.path.join("/work/alexkrau/projects/scdd/data/output/ProDrift/")
#
#     report_all = pd.DataFrame()
#     prodrift_options = ['ProDrift w50', 'ProDrift w100', 'ProDrift w200', 'ProDrift wadwin']
#     for prodrift_option in prodrift_options:
#         for LAG in cfg.RELATIVE_LAG:
#             base_path = os.path.join(base_path_main, prodrift_option)
#             file_name = f"evaluation_results_general_{LAG}_lag.csv"
#             full_path = os.path.join(base_path, file_name)
#             report = main(full_path)
#             report['technique'] = 'Baseline_ProDrift'
#             report['window'] = prodrift_option.split("_")[1]
#             report['lag'] = LAG
#             report_all = pd.concat([report_all, report], ignore_index=True)
#
#     report_all.to_csv(os.path.join(base_path_main, f'ProDrift_evaluation_results_all.csv'), index=True)
#
#     #evaluation_report = pd.read_csv(os.path.join(base_path, f'{file_name[:-4]}_evaluated.csv'))
#     #evaluation_report_agg = get_total_evaluation_results(evaluation_report)
#     #get_confusion_matrix(evaluation_report)
